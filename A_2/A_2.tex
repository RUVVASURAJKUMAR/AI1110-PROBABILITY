...
$X_{i}$=represents occurence of 0,1,3,5,7 in $i$th digit where $ i $ \in \cbrak{1,2,3,4}\\
\Rightarrow $ X_{i} $ = \cbrak{0,1,3,5,7,} where $ i $ \in \cbrak{1,2,3,4}\\
...
\item
	...
	for $ i \neq j $ for all $ i,j $ \in \cbrak{1,2,3,4} 
...
\begin{align}
	\Rightarrow \pr{ X_{i} \neq X_{j}  } &= \frac{6 + 6 + 6}{2 \times 4 \times 3 \times 2}\\ & = \frac{18}{48}\\ & = \frac{3}{8}.
\end{align}
}
